        ...
        *,
        ...
        @tool(
            ...
            (
                ...
                "完整已返回结果保存在 result_ref；schema、row_count 与 sample 是模型预览，"
                "sample_complete 仅描述预览覆盖，结果展示遵循当前入口的交付能力。"
            ),
            {
                "type": "object",
                "properties": {
                    ...
                    "data_request_complete": {
                        ...
                        "description": (
                            ...
                            "按已保存结果判断取数覆盖，模型预览行数或界面分页不影响取数完成。"
                        ),
                    },
                },
                "required": ["steps"],
        ...
        @tool(
            ...
            (
                ...
                "返回内容进入模型上下文，用于分析、比较、核验等需要具体内容的工作；"
                "读取一页不改变已存结果和界面可展示的范围。"
            ),
            {
                "type": "object",
                "properties": {
